...
final deta = Deta(projectKey: bloodyProjectKey, client: DioClientDetaApi(dio: Dio()));
final detabase = deta.base(baseName);

//
put()async{
  print('about to start putting');
 var res = await deta.base(baseName).put({'name':'oluwapelumi','age':'324'});
print(res);
...
//
final categoryApi = deta.base('category');
